      ...
      {open && (
        ...
        >
          <p style={{ margin: '0 0 8px', color: 'var(--pico-muted-color)', fontSize: 12 }}>
            Заполните репозиторий и Personal Access Token (права repo). После сохранения изменения в заметках, блоге, словаре, калькуляторах, CV и порядке окон будут автоматически пушиться в репо.
          </p>
